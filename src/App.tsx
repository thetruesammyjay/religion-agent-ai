...
function getApiFaith(faith: Faith): ApiFaith {
    return faith === "Christian" || faith === "Islamic" ? faith : "Both";
}
    ...
    const handleSubmit = async (text: string, faith: Faith) => {
        ...
        try {
            ...
            if (faith === "Interfaith") {
                ...
                setResponse({
                    ...data,
                    maharaj_ji_teaching: getMaharajJiGuidance(
                        text,
                        data.detect_emotion
                    ),
                ...
                <header className="text-center max-w-4xl mx-auto">
                    ...
                    <div className="inline-block relative sm:p-4 pt-8">
                        ...
                        <p className="sm:text-lg text-gray-500 max-w-3xl mx-auto pt-4 leading-relaxed font-light">
                            ...
                            guidance from the Bible, Quran, and Maharaj Ji
                            teachings.
                        </p>
                    </div>
                </header>
